...
public static class Utils
{
    ...
    public static Rect GetBoundingBoxOnScreen(Bounds bounds, Camera camera)
    {
        ...
        Rect retVal = Rect.MinMaxRect(float.MinValue, float.MinValue, float.MaxValue, float.MaxValue);
    ...
    //used to handle keyboard input, encapsulating different keyboard layouts
